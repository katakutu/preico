    ...
    <div class='col-xs-12'>
        <div class="page-title">
            ...
            <div class="pull-right hidden-xs">
                <ol class="breadcrumb">
                    <li>
                        <a href="#"><i class="fa fa-home"></i>Withdraw</a>
                    </li>
                </ol>
            </div>
    ...
    <div class="col-lg-12">
        <section class="box ">
            <header class="panel_header">
                <h2 class="title pull-left">Withdraw Bitcoin (BTC)</h2>
            </header>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form action="#" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="" class="control-label">BTC Address </label>
                                    <input type="text" name="btc_address"  class="form-control"  required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="" class="control-label">BTC Amount</label>
                                    <input type="text" name="btc_amount" class="form-control" required>
